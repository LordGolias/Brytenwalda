...
#gdw71115 polearmfix see numbers for polearm
#item flags
...
itp_civilian                 = 0x0000000020000000  # cloth item is used indoors
...
max_inventory_items = 96#gfe was 96
num_equipment_kinds = ek_food + 1
num_weapon_proficiencies = 8
...
#combined capabilities#itp_offset_lance| removed to see actual size for staff and banner and spear
##armors
pbody = itp_merchandise|itp_type_body_armor|itp_covers_legs|itp_civilian


pfeet = itp_type_foot_armor |itp_civilian | itp_attach_armature
pcivnom = itp_type_body_armor |itp_covers_legs|itp_civilian
probe = itp_type_body_armor|itp_covers_legs|itp_civilian
 
pnbl = itp_type_body_armor|itp_covers_legs
pmail = itp_merchandise|itp_type_body_armor|itp_covers_legs|itp_civilian
pmailnm = itp_type_body_armor|itp_covers_legs
phelmcv = itp_merchandise|itp_type_head_armor|itp_civilian
phelm = itp_merchandise|itp_type_head_armor  ##for nobility who don't wear helms except when on the battlefield
phelmnom = itp_type_head_armor
pcloak = itp_merchandise|itp_type_head_armor| itp_attach_armature| itp_doesnt_cover_hair|itp_fit_to_head|itp_civilian
pcloaknom = itp_type_head_armor| itp_attach_armature| itp_doesnt_cover_hair|itp_fit_to_head|itp_civilian
psword = itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_next_item_as_melee
pswordalt = itp_type_one_handed_wpn|itp_primary

itp_staff = itp_type_polearm|itp_merchandise|itp_primary|itp_penalty_with_shield|itp_wooden_parry
itp_banner = itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_cant_use_on_horseback|itp_two_handed#
itp_spear = itp_type_polearm|itp_merchandise|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_next_item_as_melee
itp_pike = itp_type_polearm|itp_merchandise|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_next_item_as_melee
itp_spearunique = itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_next_item_as_melee
itp_bladespear = itp_type_polearm|itp_merchandise|itp_two_handed|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_next_item_as_melee
itp_spearalt = itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack
...
itp_test2hspear = itp_type_two_handed_wpn|itp_primary|itp_penalty_with_shield|itp_wooden_parry 
itp_test1hspear = itp_type_one_handed_wpn|itp_primary|itp_penalty_with_shield|itp_wooden_parry 
itp_2hax   = itp_type_two_handed_wpn|itp_primary|itp_cant_use_on_horseback|itp_bonus_against_shield|itp_merchandise|itp_two_handed|itp_next_item_as_melee|itp_wooden_parry
itp_2haxb  = itp_type_two_handed_wpn|itp_primary|itp_cant_use_on_horseback|itp_bonus_against_shield|itp_two_handed|itp_wooden_parry
itp_2haxuq = itp_type_two_handed_wpn|itp_primary|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_next_item_as_melee|itp_wooden_parry
itp_2haxuqb= itp_type_two_handed_wpn|itp_primary|itp_bonus_against_shield|itp_wooden_parry
itp_sleg = itp_type_two_handed_wpn|itp_merchandise|itp_primary|itp_cant_use_on_horseback|itp_bonus_against_shield|itp_can_knock_down|itp_crush_through|itp_bonus_against_shield
itp_clb = itp_type_one_handed_wpn|itp_merchandise|itp_secondary|itp_wooden_parry|itp_wooden_parry|itp_wooden_attack
itp_bln = itp_type_one_handed_wpn|itp_merchandise|itp_primary|itp_crush_through|itp_next_item_as_melee
itp_knif = itp_type_one_handed_wpn|itp_merchandise|itp_primary|itp_secondary|itp_no_parry
#itp_swd1h = itp_type_one_handed_wpn|itp_merchandise|itp_primary|itp_next_item_as_melee
itp_axe1h = itp_type_one_handed_wpn|itp_merchandise|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry|itp_next_item_as_melee
itp_axe1halt = itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_wooden_parry|itp_wooden_attack
itp_ax1huq = itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry|itp_next_item_as_melee
itp_ax1huqb = itp_type_two_handed_wpn|itp_primary|itp_crush_through|itp_can_knock_down

itc_cleaver = itcf_force_64_bits | itcf_overswing_onehanded|itcf_slashright_onehanded|itcf_slashleft_onehanded |itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded
itc_seax  = itc_cleaver | itcf_thrust_onehanded
...
itc_longsword = itc_seax | itc_parry_onehanded
itc_axe1h  = itc_cleaver |itc_parry_onehanded|itcf_carry_axe_left_hip
...
itc_bln = itc_cleaver|itc_parry_onehanded|itcf_carry_axe_left_hip
...
itc_2hax = itcf_force_64_bits | itcf_slashright_twohanded | itcf_slashleft_twohanded | itcf_overswing_twohanded | itc_parry_two_handed|itcf_carry_axe_back
itc_sleg = itcf_force_64_bits | itcf_slashright_twohanded | itcf_slashleft_twohanded | itcf_overswing_twohanded|itcf_carry_axe_back
...
itc_bastardsword = itc_cut_two_handed |  itcf_thrust_twohanded | itc_parry_two_handed |itc_seax
...
itc_staff      = itc_parry_polearm|  itcf_carry_spear |itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback| itcf_overswing_polearm|itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm
itc_spear      = itc_parry_polearm| itcf_carry_spear |itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_overswing_musket| itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm
itc_bladespear  = itc_parry_polearm|  itcf_carry_spear |itcf_overswing_musket|itcf_slashright_polearm|itcf_slashleft_polearm| itcf_thrust_polearm
itc_pike       = itc_parry_polearm|itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm|itcf_overswing_musket
itc_banner    = itc_parry_polearm|  itcf_carry_spear | itcf_overswing_polearm|itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm
