...
ready_durn     = 0.35
defend_duration = 0.75 #chief cambiado
...
##   [1.09, "jump", 22, 48, arf_blend_in_1],
   [0.8, "kick_rightleg", 12, 33, arf_blend_in_1],
 ],
...
# duration and controlled via weapon speed.
 ...
 #there is a throw_javelin" animationa as well to try
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 ["ready_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.6, "sling_long", 0, 31, blend_in_ready],
 ],
 ["release_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.7, "throwing_stone", 28, 56, arf_blend_in_1],
 ],
...
["ready_swingright_fist", 0, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_right,
 ...
 ["release_swingright_fist", 0, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right,
   [0.6, "right_swing", 15, 41, blend_in_release], 
 ],
 ...
 ["release_swingleft_fist", 0, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left,
   [0.6, "anim_human", combat+4300, combat+4335, blend_in_release], 
 ],
 ...
 ["release_direct_fist", 0, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust,
   [0.6, "direct_fist", 17, 36, blend_in_release], 
 ],
 ...
 ["release_uppercut_fist", 0, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust,
   [0.6, "uppercut", 17, 34, blend_in_release], 
 ],
...
##   [0.61, "anim_human", combat+8510, combat+8540, blend_in_release], 
   [0.4, "attacks_thrust_onehanded", 12, 32, blend_in_release], #bas cambia chief
 ],
 ["release_thrust_onehanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust|amf_client_owner_prediction,
   [0.25, "attacks_thrust_onehanded", 32, 54, blend_in_continue],  #bas cambia chief
 ],
...
##   [0.6, "anim_human", combat+7334, combat+7340, blend_in_release],#gdw used native 
...
###VictorF  animations empieza chief escudo
...
##   [defend_duration, "defend_shield_forwardm", 6, 25, blend_in_defense], 
##  ],
...
##   [defend_duration, "defend_shield_upm", 1, 27, blend_in_defense], 
##  ],
...
##   [defend_duration, "defend_shield_rightm", 5, 26, blend_in_defense], 
##  ],
...
##   [defend_duration, "defend_shield_leftm", 5, 26, blend_in_defense], 
##  ],
##
...
##   [defend_duration, "defend_shield_upm", 1, 17, blend_in_defense], 
##  ],
...
##   [defend_keep_duration, "defendgrip_front", 48, 50, arf_blend_in_4|arf_cyclic], 
## ],
...
##   [defend_parry_duration_1, "defendgrip_front", 51, 60, arf_blend_in_1], 
## ],
...
##   [defend_parry_duration_2, "defendgrip_front", 51, 60, arf_blend_in_1], 
## ],
...
##   [defend_parry_duration_3, "defendgrip_front", 51, 60, arf_blend_in_1], 
## ],

#native, parece que a los players no les gusta la nueva animacion.
...
#   [defend_duration, "defend_shield_parry_all", 5, 26, blend_in_defense], 
 ...
 ["defend_shield_keep", acf_parallels_for_look_slope|acf_anim_length(100), amf_rider_rot_shield|amf_priority_defend|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   [defend_keep_duration, "defendshield2", defend+118, defend+120, arf_blend_in_4|arf_cyclic], 
 ],
 ["defend_shield_parry_1", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   [defend_parry_duration_1, "defendshield2", defend+121, defend+130, arf_blend_in_1], 
 ],
 ["defend_shield_parry_2", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   [defend_parry_duration_2, "defendshield2", defend+121, defend+130, arf_blend_in_1], 
 ],
 ["defend_shield_parry_3", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   [defend_parry_duration_3, "defendshield2", defend+121, defend+130, arf_blend_in_1], 
 ],
 
## #VictorF  animations chief acaba
...
####native, sin cambios de altura, sustituir por la siguiente si queremos diferentes alturas en el juego
...
#####dunde retrasa death animation para solucionar el problema de brazos largos y sin manos del sistema de alturas chief
## ["fall_face_hold", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
##   [2.2, "death_face", 8, 60, arf_blend_in_16|arf_make_custom_sound, pack2f(0.5, 0.0), (0,0,0), 3],
## ],
## ["fall_chest_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
##   [1.0, "death_chest", 4, 37, arf_blend_in_16|arf_make_custom_sound, pack2f(0.9, 0.0), (0,0,0), 2.9],
## ],
## ["fall_abdomen_hold_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
##   [2.7, "death_abdomen", 5, 96, arf_blend_in_16|arf_make_custom_sound, pack2f(0.4, 0.0), (0,0,0), 2.9],
## ],
## ["fall_head_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
##   [1.2, "anim_human", blow+100, blow+138, arf_blend_in_16|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 3.2], 
## ],
## ["fall_right_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
##   [2.0, "death2", 0, 53, arf_blend_in_16|arf_make_custom_sound, pack2f(0.65, 0.0), (0,0,0), 3.4], 
## ],
## ["fall_body_back", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
##   [2.7, "death", 0, 83, arf_blend_in_16|arf_make_custom_sound, pack2f(0.47, 0.82), (0,0,0), 4.2], 
## ], #dunde acaba chief
 
## ["fall_rider_head_front", acf_enforce_all,
##   [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3],]
#gdw 4 Values below were 2.8 in BW141
 ["fall_rider_right_forward", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.7], 
...
## ],
 ["rider_fall_right", acf_enforce_all|acf_displace_position, amf_priority_fall_from_horse|amf_play|amf_accurate_body|amf_client_prediction,
   [2.5, "anim_human_02", 350, 382,  arf_blend_in_8, 0, (0.8,-1.8,0), 1.0],
 ],
 ["rider_fall_roll", acf_enforce_all|acf_displace_position, amf_priority_fall_from_horse|amf_play|amf_accurate_body|amf_client_prediction,
   [2.5, "anim_human", blow+ 2000, blow+2084,  arf_blend_in_8, 0, (0.0,0.0,0), 2.0],
 ], #dunde acaba chief it was 3.4 and 2.0 for riderfallright
...
##if put shield wall here it causes errors
 ...
 ["reload_musket_full", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [2.5, "reload_pistol_new", 0, 340, arf_stick_item_to_left_hand|arf_blend_in_3],
 ],
 ###reload_pistol_new=man_reload
 ["reload_musket_two_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [1.7, "reload_pistol_new", 110, 340, arf_stick_item_to_left_hand|arf_blend_in_3],
 ],
 ["reload_musket_one_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [0.6, "reload_pistol_new", 270, 340, arf_stick_item_to_left_hand|arf_blend_in_3],
 ],
 ...
 ["ready_overswing_spear", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
	[ready_durn, "attacks_staff_thrust_overhead", 4, 20, blend_in_ready],
 ],
 #gdw the 4 below were all spear_thrust_overhead but the game could not find the animation for this
 ["release_overswing_spear", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
 	[0.55, "attacks_staff_thrust_overhead", 20, 42, blend_in_release],
 ],
 ["release_overswing_spear_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.3, "attacks_staff_thrust_overhead", 42, 50, arf_blend_in_2],
 ],
 ["parried_overswing_spear", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [0.4, "attacks_staff_thrust_overhead", 51, 43, arf_blend_in_2],
 ],
 ["blocked_overswing_spear", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [0.4, "attacks_staff_thrust_overhead", 50, 42, arf_blend_in_2],
 ],
 ["reload_pistol_half", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [1.2, "reload_pistol_new", 125, 250, arf_blend_in_3],
 ],
 #gdw this set is from the overshield 1 h thrust packet from the forge. it depends on checking musket in items as well as the new brf fiel for spear_1hthrust. the one below is my creation as of 61815
 ["ready_overswing_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  #[ready_durn, "attacks_fow1hoh", 12, 24, blend_in_ready],
  [ready_durn, "attacks_staff_thrust_overhead", 4, 20, blend_in_ready], 
 ],
 ...
 ["parried_overswing_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
  [attack_parried_duration, "attacks_staff_thrust_overhead", 50, 43, blend_in_parry],
 ],
 ["blocked_overswing_musket", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [attack_blocked_duration, "attacks_staff_thrust_overhead", 49, 43, blend_in_parry],
 ],
...
["spearwall_hold", 0, acf_thrust|acf_enforce_all|acf_align_with_ground,
   [4.0, "anim_human", combat+7310, combat+7310, blend_in_ready],
 ],
###rigale chief para legshot, esta mal
 ["fall_head_front_legshot",  acf_enforce_all, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   [0.55, "strikes", 2284, 2305, arf_blend_in_3], 
 ],
 ##
  # HUNT ADDITIONS

 ["taunt", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction, [3, "taunt_1h_s3", 5, 90, arf_blend_in_1]],
 ["pevic_thrust", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction, [2, "pelvic_thrust", 90, 165, arf_blend_in_1]],
 
 ["howl", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
##   [2.5, "anim_human", 70000, 70045, arf_blend_in_5], 
##   [3.0, "anim_human", 70100, 70150, arf_blend_in_5],
 ...
 ["tekst", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction, [3, "tekst", 1, 10, arf_blend_in_1]],
 ["fatigues1", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction, [3, "taunt", 5, 90, arf_blend_in_1]],###rigale chief para legshot, esta mal
#########chief animations empieza####################
#####
...
["shield_bash", acf_enforce_all|acf_align_with_ground, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
 ...
 ["shield_strike", acf_enforce_all, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   [0.9 * 1.2, "strikes3_abdomen_back", 0, 53, arf_blend_in_3], 
 ],
 ## ["unused_human_anim_45", 0, 0, [1.0, "anim_human", 0, 1, 0]],
## ["unused_human_anim_46", 0, 0, [1.0, "anim_human", 0, 1, 0]],
