...
#resto facciones meshes
    ("pic_arms_swadian7", 0, "pic_arms_swadian", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_vaegir8", 0, "pic_arms_vaegir", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_khergit9", 0, "pic_arms_swadian", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_nord10", 0, "pic_arms_nord", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_rhodok11", 0, "pic_arms_rhodok", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sarranid_arms12", 0, "pic_sarranid_arms", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_swadian13", 0, "pic_arms_swadian", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_vaegir14", 0, "pic_arms_swadian", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_khergit15", 0, "pic_arms_khergit", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_nord16", 0, "pic_arms_nord", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_rhodok17", 0, "pic_arms_rhodok", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sarranid_arms18", 0, "pic_sarranid_arms", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_swadian19", 0, "pic_arms_swadian", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_vaegir20", 0, "pic_arms_vaegir", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_khergit21", 0, "pic_arms_khergit", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_nord22", 0, "pic_arms_nord", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_rhodok23", 0, "pic_arms_rhodok", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sarranid_arms24", 0, "pic_sarranid_arms", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_swadian25", 0, "pic_arms_swadian", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_vaegir26", 0, "pic_arms_vaegir", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_khergit27", 0, "pic_arms_khergit", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_nord28", 0, "pic_arms_nord", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_rhodok29", 0, "pic_arms_rhodok", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sarranid_arms30", 0, "pic_sarranid_arms", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sarranid_arms31", 0, "pic_sarranid_arms", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("banner_a15", 0, "banner_f21", 0, 0, 0, -90, 0, 180, 1, 1, 1),
  ...
  ("banner_d21", 0, "banner_d21", 0, 0, 0, -90, 0, 180, 1, 1, 1),
  ...
  ("banner_e08", 0, "banner_e08", 0, 0, 0, -90, 0, 180, 1, 1, 1),
...
#chief
#  ("banner_f21", 0, "banner_f21", 0, 0, 0, -90, 0, 180, 1, 1, 1),
...
#chief acaba
  ...
  ("banner_g01", 0, "banner_f21", 0, 0, 0, -90, 0, 180, 1, 1, 1),
...
#chief acaba
  ("banner_k21", 0, "banner_a15", 0, 0, 0, -90, 0, 0, 1, 1, 1), #chief modifica
...
#chief
  # ("arms_f21", 0, "banner_f21", 0, 0, 0, -90, 0, 180, 1, 1, 1),
...
#chief acaba
  ("arms_k21", 0, "banner_a15", 0, 0, 0, -90, 0, 0, 1, 1, 1), #chief modifica
...
#### JEDEDIAH chief Q mesh for Companions Overview ##############################
  ("cpov", 0, "cpov", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("cpovxt", 0, "cpovxt", 0, 0, 0, 0, 0, 0, 1, 1, 1),
#### JEDEDIAH Q mesh for Companions Overview END ##########################
#TEMPERED ADDED CORE GAME RESOURCES
...
#otros chief
  ...
  ("infiltrado", 0, "infiltrado", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("pic_extra_malvado", 0, "pic_extra_malvado", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("pic_extra_town1", 0, "pic_extra_town1", 0, 0, 0, 0, 0, 0, 1, 1, 1), #ciudades
  ("pic_extra_town2", 0, "pic_extra_town2", 0, 0, 0, 0, 0, 0, 1, 1, 1), #castillos

  ("pic_bandits1", 0, "pic_bandits1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_messenger1", 0, "pic_messenger1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_prisoner_wilderness1", 0, "pic_prisoner_wilderness1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_escape_11", 0, "pic_escape_11", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_escape_1_fem1", 0, "pic_escape_1_fem1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_victory1", 0, "pic_victory1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_defeat1", 0, "pic_defeat1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_wounded1", 0, "pic_wounded1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_wounded_fem1", 0, "pic_wounded_fem1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_steppe_bandits1", 0, "pic_steppe_bandits1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_mountain_bandits1", 0, "pic_mountain_bandits1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sea_raiders1", 0, "pic_sea_raiders1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_deserters1", 0, "pic_deserters1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_forest_bandits1", 0, "pic_forest_bandits1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
   ("pic_looted_village1", 0, "pic_looted_village1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_village_p1", 0, "pic_village_p1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_village_s1", 0, "pic_village_s1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_village_w1", 0, "pic_village_w1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_charge1", 0, "pic_charge1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_khergit1", 0, "pic_khergit1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_nord1", 0, "pic_nord1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_rhodock1", 0, "pic_rhodock1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sally_out1", 0, "pic_sally_out1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_siege_attack1", 0, "pic_siege_attack1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_swad1", 0, "pic_swad1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_vaegir1", 0, "pic_vaegir1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sarranid_encounter1", 0, "pic_sarranid_encounter1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_extra_duelos", 0, "pic_extra_duelos", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_extra_barco2", 0, "pic_extra_barco2", 0, 0, 0, 0, 0, 0, 1, 1, 1),
