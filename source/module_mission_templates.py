       ...
       [
		...
		(call_script, "script_change_troop_renown", "trp_player", 25),
   		#(call_script, "script_troop_add_gold", "trp_player", 600),#gdw companions get the rest
            ...
            (troop_add_item, "trp_player","itm_noblearmor4res",0),
            (troop_add_item, "trp_player","itm_elite2_2haxeresrv",0),
            (troop_add_item, "trp_player","itm_shield_round_7", 0),
...
#chief cambia armas en arena
  (
    ...
    [
      (0,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_practice_seaxe", "itm_arena_tunic_red", "itm_arena_skullcap_red", "itm_arena_shieldred"]),
      ...
      (3,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_javelins", "itm_arena_tunic_red", "itm_arena_skullcap_red"]),
      (4,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_red"]),
      (5,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_arena_tunic_red"]),
      (6,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_red"]),
      (7,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, ARENA_HORSE, "itm_arena_tunic_red", "itm_arena_skullcap_red"]),

      (8,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_practice_seaxe", "itm_arena_tunic_blue"]),
      ...
      (11,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_javelins", "itm_arena_tunic_blue", "itm_arena_helm_blue"]),
      (12,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_blue"]),
      (13,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_arena_tunic_blue", "itm_arena_helm_blue"]),
      (14,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_blue"]),
      (15,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, ARENA_HORSE, "itm_arena_tunic_blue"]),

      (16,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_practice_seaxe", "itm_arena_tunic_green", "itm_arena_helm_green"]),
      ...
      (19,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_javelins", "itm_arena_tunic_green", "itm_arena_helm_green"]),
      (20,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_green", "itm_arena_helm_green"]),
      (21,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_arena_tunic_green"]),
      (22,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_green"]),
      (23,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, ARENA_HORSE, "itm_arena_tunic_green", "itm_arena_helm_green"]),

      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_practice_seaxe", "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
      ...
      (27,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_javelins", "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
      (28,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
      (29,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_arena_tunic_yellow"]),
      (30,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_yellow"]),
      (31,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, ARENA_HORSE, "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
#32
      (32, mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,["itm_practice_sword"]),
      (33,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD]),
      (34,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD]),
      (35,mtef_visitor_source|mtef_team_4,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD]),
      (36, mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_practice_seaxe"]),
      (37,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD]),
      (38,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword"]),
      (39,mtef_visitor_source|mtef_team_4,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD]),
#40-49 not used yet
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_practice_seaxe", "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
      ...
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_javelins", "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_arena_tunic_yellow"]),
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_staff", ARENA_SHIELD, "itm_arena_tunic_yellow"]),
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, ARENA_HORSE, "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_practice_seaxe", "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,["itm_practice_sword", ARENA_SHIELD, "itm_practice_seaxe", "itm_arena_tunic_yellow", "itm_arena_helm_yellow"]),
...
#used for torunament master scene
      ...
      (56, mtef_visitor_source|mtef_team_0, af_override_all, aif_start_alarmed, 1, ["itm_practice_sword", ARENA_SHIELD, "itm_linen_coatwcloak", "itm_skullcapt1"]), #cambiado chief
      (57, mtef_visitor_source|mtef_team_0, af_override_all, aif_start_alarmed, 1, ["itm_practice_sword", ARENA_SHIELD, "itm_linen_coatwcloak", "itm_skullcapt1"]), #cambiado chief
    ],
    tournament_triggers
  ),
...
(0, mtef_visitor_source|mtef_team_0, af_override_weapons, aif_start_alarmed, 1, ["itm_spathaswordt2", "itm_shield_gaelic_small_1"]),
(8, mtef_visitor_source|mtef_team_2,af_override_weapons, aif_start_alarmed, 1, ["itm_spathaswordt2", "itm_shield_gaelic_small_6"]),
#visitors 6 and 7 are sword/shield no horse
(56, mtef_visitor_source|mtef_team_0, af_override_weapons|af_override_horse, aif_start_alarmed, 1, ["itm_spathaswordt2", "itm_shield_gaelic_small_1"]),
(58, mtef_visitor_source|mtef_team_2,af_override_weapons|af_override_horse, aif_start_alarmed, 1, ["itm_spathaswordt2", "itm_shield_gaelic_small_6"]),
...
#trigger to spawn unmounted horses in camp, in line formation (requires a spawn point 47 and 48 for start and end of line).
	(0,0,ti_once,[],[  
					...
					(try_for_range,":unused",0,":horse_count"),
						...
						(try_begin),
							(le,":random_no",100),
							(assign,":horse_type","itm_horse_0l_2"),
						(else_try),
							(ge,":random_no",200),
							(assign,":horse_type","itm_horse_pony"),
						(else_try),
							(is_between,":random_no",100,200),
							(assign,":horse_type","itm_horse_0n_2"),
						(try_end),
