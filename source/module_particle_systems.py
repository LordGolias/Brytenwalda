...
particle_systems = [  
#chief cambia cosas en rain y snow
    ("game_rain", psf_billboard_2d|psf_global_emit_dir|psf_always_emit, "prtcl_rain",
     800, 0.7, 0.33, 2.0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength#gdw 800 was 1000
    ...
    ("game_snow", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_snow_fall_1",
     ...
     (1.0, 1.0), (1, 1.0),      #green keys
     (1.0, 1.0), (1, 1.0),      #blue keys
     (1.0, 1.4),   (1.0, 1.4),   #scale keys#gdw 1.4 was 1.7
...
#chief cambiado
 ...
 #    0.5                        #rotation damping
 #   ),
#TEMPERED chief CHANGED HOOF DUST cambio
...
#torneos personalizados chief
    ...
    #torneos personalizados acaba chief
...
##   ), 
   ("wake", psf_always_emit|psf_emit_at_water_level , "prt_mesh_water_wave_1",
    4, 10.0, 0, 0.0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    (0.03, 0.2), (1, 0.0),        #alpha keys
    (0.3, 0.3), (0.3, 0.3),      #red keys
    (0.3, 0.3), (0.3, 0.3),      #green keys
    (0.3, 0.3), (0.3, 0.3),     #blue keys
    (0.0, 30.0),   (100.0, 1000),   #scale keys
    (0.0, 0.0, 0.0),           #emit box size
    (0, 0, 0),                 #emit velocity
    0.0,                       #emit dir randomness
    0,                       #rotation speed
...
#chief anadido para decapitacion
    ...
    ("boiling_water", psf_billboard_3d | psf_randomize_size|psf_randomize_rotation ,  "prt_mesh_smoke_1",#gdw was agua_hirviendo
     5000, 5, 1, 0.5, 10, 10,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    ...
    #chief siege warfare acaba
    #fire arrow chief
      ("small_explosion", psf_billboard_3d|psf_randomize_rotation|psf_2d_turbulance, "prt_mesh_fire_1",#prt_mesh_dust_1
     5000, 2.0,  1, -0.03, 1, 0,	#num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 1.0), (0.1, 0),			#alpha keys
     (0.5, 0.5*1.0), (1, 0.3*0.9),	#red keys
     (0.5, 0.5*0.7),(1, 0.3*0.3),	#green keys
     (0.5, 0.5*0.2), (1, 0.0),		#blue keys
     (0, 2), (1, 0),			#scale keys
     (0.1, 0.1, 0.1),				#emit box size
     (0.0, 0.0, 1),					#emit velocity
     4.0,							#emit dir randomness
     200,							#rotation speed
     0.2							#rotation damping
    ),
   ("massive_fire", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
    50, 1.5, 0.1, -0.2, 25.0, 5.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    (0.2, 0.7), (1, 0),        #alpha keys
    (0.2, 1.0), (1, 0.9),      #red keys
    (0.2, 0.7),(1, 0.3),       #green keys
    (0.2, 0.2), (1, 0.0),      #blue keys
    (0, 1),   (1, 3),   #scale keys
    (0.5, 0.5, 0.1),            #emit box size
    (0, 0, 0.0),               #emit velocity
    0.3,                       #emit dir randomness
    250,                       #rotation speed
    0.3                        #rotation damping
    ...
    ("greek_fire", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",#
     50, 0.2, 0.2, 0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.5), (0.9, 0),        #alpha keys
     (0.3, 1.0), (1, 0.9),      #red keys
     (0.3, 0.7),(1, 0.3),       #green keys
     (0.3, 0.2), (1, 0.0),      #blue keys
     (0, 0.35),   (1, 0.35),   #scale keys###############################
     (0.04, 0.04, 0.01),      #emit box size
...
#fire arrow acaba
    ###sea battle chief Phaiak
	### particle systems for KLABAUTERMANN begin
    ("front_water", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation|psf_emit_at_water_level, "prtcl_splash_b",
     50, 0.4, 2, 3, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.3, 1.0), (1, 0.3),        #alpha keys
     (3.0, 1.0), (6, 0.5),      #red keys
     (3.0, 1.0), (6, 1.5),      #green keys
     (3.0, 1.0), (6, 1.0),      #blue keys
     (0.0, 2.5),   (0.4, 1.2),   #scale keys
     (0.5, 0.5, 0.7),           #emit box size
     (1, 1.3, 5.1),               #emit velocity
     0.7,                       #emit dir randomness
     50,                       #rotation speed
     0.5                        #rotation damping
    ),
	
    ("heck_water", psf_randomize_size|psf_emit_at_water_level, "prtcl_splash_b",
     23, 12.0, 2, 0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.6), (1, 0.1),        #alpha keys
     (3.0, 1.0), (6, 0.5),      #red keys
     (3.0, 1.0), (6, 1.5),      #green keys
     (3.0, 1.0), (6, 1.0),      #blue keys
     (0.3, 1.0),   (9.0, 0.1),   #scale keys
     (1.0, 0.7, 0.0),           #emit box size
     (0, 0.0, 0),               #emit velocity
     0.0,                       #emit dir randomness
     0,                       #rotation speed
     0.5                        #rotation damping
    ),
	### particle systems for KLABAUTERMANN end
    ###sea battle acaba Phaiak
]
