...
from . import loans, enterprise, battle, multiplayer, constable, minister
     ...
     [
       ...
       (else_try),
         ...
         (try_begin),
           ...
           (assign, "$g_quick_battle_team_1_faction", "fac_outlaws"),
         (else_try),
           (store_add, "$g_quick_battle_team_1_faction", ":value", npc_kingdoms_begin),#Player Faction??gdw
         (try_end),
       (else_try),
   ...
   ("skirmishers",0, "mesh_load_window",[
      (ti_on_presentation_load,
       [(presentation_set_duration,999999),
	    ...
	    (party_count_members_of_type,"$max_skirmishers","p_main_party","trp_merc_spy"),
  ...
  ("budget_report", 0, "mesh_load_window",
   [(ti_on_presentation_load,
     [(presentation_set_duration, 999999),
      ...
      enterprise.budget_report_statement_block,
	  ...
	  (try_for_parties, ":party_no"),
        ...
        (try_end),
        (try_begin),
          (this_or_next|eq, ":party_no", "p_fort"), # TML Added fort to act like garrison for troop wages. F123 - Submod = 1.41
          (eq, ":garrison_troop", 1),
        ...
        (this_or_next|eq, ":party_no", "p_temp_loot_wagon"),
          ...
          (val_mul, ":num_troops", 9), ##approx weekly food consumption # TML Reduced this from 12 to 3, food in the game just doesn't cost that much. F123 - Submod -> 1.41#gdw6 but food prep pres and logistic of finding is expensive
          (store_sub, ":total_payment_ratio", 14, "$g_cur_week_half_daily_wage_payments"), #between 0 and 7
          (val_mul, ":total_wage", ":total_payment_ratio"),
          (val_div, ":total_wage", 14),
      ...
      #salarios fort y salt mine chief acaba
         (else_try),
          (party_slot_eq, ":party_no","slot_party_type", spt_companion_raider), #F123 - Submod -> 1.41
          (party_get_num_companions, ":num_troops", ":party_no"), ## headcount for food cost
          (val_mul, ":num_troops", 3), ##approx weekly food consumption # TML Reduced this from 12 to 3, food in the game just doesn't cost that much. F123 - Submod -> 1.41
          (store_sub, ":total_payment_ratio", 14, "$g_cur_week_half_daily_wage_payments"), #between 0 and 7
          (val_mul, ":total_wage", ":total_payment_ratio"),
          (val_div, ":total_wage", 14),
          (val_add, ":total_wage", ":num_troops"), ##food cost
...
##        (gt, ":total_wage", 0),
	    ...
	    (this_or_next|eq, ":party_no", "p_main_party"), # Added these two lines to prevent salt mine, lair, and supply wagon showing up when you aren't using them. TML. F123 - Submod -> 1.41
	    (gt, ":total_wage", 0),
...
# __Freelancer Report: Commander_:Start_________________________________________________
  ...
  ("taragoth_lords_report", 0, "mesh_load_window", [
	...
	[
		...
		#next_pay
		(str_store_date, s25, "$freelancer_next_pay_time"), # TML Added new global to get the pay time set up correctly, wasn't always right when using the other one. F123 - Submod -> 1.41
   ...
   ("wagon_leader",0, "mesh_load_window",[
      (ti_on_presentation_load,
       [	(presentation_set_duration,99999),
			...
			(try_end),
#hero slider        
			(create_slider_overlay, "$g_presentation_obj_15", "trp_npc1", "trp_npc_irish1"),               
			(position_set_x, pos1, 500),
			(position_set_y, pos1, 500),
			(overlay_set_position, "$g_presentation_obj_15", pos1),
...
#abandon wagon
		...
		(position_set_x, pos1, 50),#gdw this button is easy mistake plus can do it from camp menu
		(position_set_y, pos1, 100),
		(overlay_set_position, "$g_presentation_obj_11", pos1),
  ...
  ("upgrade_tree_1", 0, "mesh_load_window", [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 0, "trp_briton_recruit", 115, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 1, "trp_briton_footmant2", 265, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 2, "trp_briton_skirmt3", 415, 400),#gdw gwrda not main line sw again
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 3, "trp_briton_horseman", 565, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 4, "trp_briton_cavalry", 715, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 5, "trp_briton_skirmishert4", 565, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 6, "trp_briton_infantryt3", 415, 100),#gdwnow pedyt sw again
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 7, "trp_briton_infantryt4", 565, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 8, "trp_briton_archer", 715, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 9, "trp_briton_longbowman", 855, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 10, "trp_briton_troopelite", 715, 300),
        
        ## cost
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_briton_recruit", 195, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_briton_footmant2", 320, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_briton_skirmt3", 470, 510),#gdw
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_briton_horseman", 645, 610),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_briton_infantryt3", 495, 210),#gdwretrunorig
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_briton_archer", 795, 210),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_briton_skirmishert4", 645, 410),
        ## cost
...
#    ]),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":slot_no", 0, 11),  # Fixed tree display TML. F123 - Submod = 1.41
          (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
  ...
  ("upgrade_tree_2", 0, "mesh_load_window", [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 0, "trp_saxon_recruit", 115, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 1, "trp_saxon_footmant2", 265, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 2, "trp_saxon_skirmishert3", 415, 400),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 3, "trp_saxon_skirmishert4", 565, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 4, "trp_saxon_skirmishert5", 715, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 5, "trp_saxon_horseman1", 565, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 6, "trp_saxon_infantryt3", 415, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 7, "trp_saxon_infantryt4", 565, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 8, "trp_saxon_archer", 855, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 9, "trp_saxon_infantryt5", 715, 100),
        
        ## cost
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_saxon_recruit", 195, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_saxon_footmant2", 320, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_saxon_skirmishert3", 470, 510),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_saxon_skirmishert4", 645, 610),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_saxon_infantryt3", 495, 210),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_saxon_infantryt4", 645, 210),
        ## cost
  ...
  ("upgrade_tree_3", 0, "mesh_load_window", [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 0, "trp_pict_recruit", 115, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 1, "trp_pict_footmant2", 265, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 2, "trp_pict_skirmishert3", 415, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 3, "trp_pict_horsesquiret3", 415, 400),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 4, "trp_pict_horseman", 565, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 5, "trp_pict_skirmishert4", 565, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 6, "trp_pict_infantryt4", 565, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 7, "trp_pict_noblecavalry", 715, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 8, "trp_pict_infantryt5", 715, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 9, "trp_pict_archer", 855, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 10, "trp_pict_woman", 115, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 11, "trp_irish_skirmishert4", 115, 750), #F123 - Submod -> 1.41
        
        ## cost
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_pict_recruit", 195, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_pict_footmant2", 320, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_pict_horsesquiret3", 470, 510),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_pict_infantryt4", 645, 610),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_pict_skirmishert3", 495, 210),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_pict_horseman", 645, 210),
        ## cost
  ...
  ("upgrade_tree_4", 0, "mesh_load_window", [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 0, "trp_engle_recruit", 115, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 1, "trp_engle_footmant2", 265, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 2, "trp_engle_skirmishert3", 415, 400),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 3, "trp_engle_skirmishert4", 565, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 4, "trp_engle_skirmishert5", 715, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 5, "trp_engle_horseman", 565, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 6, "trp_jute_infantryt3", 415, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 7, "trp_engle_infantryt4", 565, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 8, "trp_engle_infantryt5", 715, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 9, "trp_engle_archer", 855, 300),
        
        ## cost
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_engle_recruit", 195, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_engle_footmant2", 320, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_engle_skirmishert3", 470, 510),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_engle_skirmishert4", 645, 610),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_jute_infantryt3", 495, 210),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_engle_infantryt4", 645, 210),
        ## cost
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":slot_no", 0, 10), # Fixed tree display TML. F123 - Submod -> 1.41
          (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
          (troop_get_slot, "$temp", "trp_temp_array_b", ":slot_no"),
  ...
  ("upgrade_tree_5", 0, "mesh_load_window", [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 0, "trp_irish_recruit", 115, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 1, "trp_irish_footmant2", 265, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 2, "trp_irish_skirmishert3", 415, 400),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 3, "trp_irish_horseman", 565, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 4, "trp_irish_noblecavalry", 715, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 5, "trp_irish_skirmishert4", 565, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 6, "trp_irish_infantryt3", 415, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 7, "trp_irish_infantryt4", 565, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 8, "trp_irish_infantryt5", 715, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 9, "trp_irish_archer", 855, 100),
        
        ## cost
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_irish_recruit", 195, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_irish_footmant2", 320, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_irish_skirmishert3", 470, 510),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_irish_horseman", 645, 610),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_irish_infantryt3", 495, 210),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_irish_infantryt4", 645, 210),
        ## cost
  ...
  ("upgrade_tree_6", 0, "mesh_load_window", [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 0, "trp_jute_recruit", 115, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 1, "trp_jute_footmant2", 265, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 2, "trp_jute_skirmishert3", 415, 400),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 3, "trp_jute_skirmishert4", 565, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 4, "trp_jute_skirmishert5", 715, 500),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 5, "trp_jute_horsemant4", 565, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 6, "trp_jute_infantryt3", 415, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 7, "trp_jute_infantryt4", 565, 100),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 8, "trp_jute_archert1", 855, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 9, "trp_jute_infantryelitet5", 715, 100),
        
        ## cost
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_jute_recruit", 195, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_jute_footmant2", 320, 360),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_jute_skirmishert3", 470, 510),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_jute_skirmishert4", 645, 610),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_jute_infantryt3", 495, 210),
        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_jute_infantryt4", 645, 210),
        ## cost
  ...
  ("upgrade_tree_7", 0, "mesh_load_window", [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 2, "trp_merc_infantryt2", 265, 250),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 3, "trp_merc_infantryt3", 415, 400),
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 6, "trp_merc_infantryt4", 565, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 7, "trp_merc_infantryt5", 715, 300),
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 8, "trp_merc_archer", 415, 100),
...
##        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_merc_infantryt2", 320, 360),
##        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_merc_infantryt3", 470, 510),
##        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_mercenary_horseman", 645, 610),
##        (call_script, "script_prsnt_upgrade_tree_troop_cost", "trp_merc_infantryt4", 645, 410),
##        ## cost
##        
##        ##### - lines
  ...
  ("upgrade_tree_8", 0, "mesh_load_window", [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 8, "trp_dena_pirate", 715, 100),
  ...
  ("upgrade_tree_9", 0, "mesh_load_window", [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_upgrade_tree_troop_and_name", 8, "trp_slave_punisher", 415, 100),
...
#            (neq, ":object", "$g_jrider_faction_coat_of_arms"),
    ...
    ("order_display", prsntf_read_only, 0, [
        (ti_on_presentation_load, [
            ...
            (try_for_range, ":i", 0, 9),
                (store_add, ":slot", ":i", "slot_party_cabadrin_orders_begin"),
...
#hero slider        
			...
			(create_text_overlay, "$g_presentation_obj_17","@ {s2} siege mod.",tf_center_justify),
			(position_set_x, pos1, 500),
			(position_set_y, pos1, 600),
			(overlay_set_position, "$g_presentation_obj_17", pos1),
			(position_set_x, pos2,1000),
