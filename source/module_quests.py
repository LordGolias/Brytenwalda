...
# Note : This is defined as the first mayor quest in module_constants.py: 
 ("move_cattle_herd1", "Move Cattle Herd to {s13}", qf_random_quest,
 ...
 ("deal_with_looters", "Deal with Theows", qf_random_quest,
  "{!}The Guildmaster of {s4} has asked you to deal with several bands of theows around {s4}, and bring back any goods you recover."
  ),
...
###chief quests###########
 ("mod_trouble", "Meet with the troublemakers from Cirren Ceaster at Merceham", 0,
  "{!}Cedric has asked you to deal with a bunch of young cantabria warband making trouble around Cirren Ceaster.\
How you want to tackle the problem is up to you; He has promised a shield if you succeed."
),
 
 ("espada_beowulf", "Find the Lyre of Taliesion and the Horn of Arthur", 0,
  "{!}Bard Aneirin will give me the sword of Beowulf if I get Lyre of Taliesion and Horn of Arthur for him."
),

 ("espada_falcata", "Rescue Romans from Slavers in Roman Ruins", 0,
  "{!}You must defeat the bandits and release their prisoners. Return to Hadrian's Wall for your reward."
),

###chief acaba#######
#chief quest relic
 
("relic", "Find holy relic", 0,
"{!}A cleric called Ulcagnus told me interesting story about heresi, Arrians that stolen holy relic. I must find them and after battle, persuade their leader to give me a holy relic. Those blasphemers should be near Ynys Manaw!"
),
 #chief acaba

("escort_bishop", "Escort the bishop to {s8}", qf_random_quest,
  "{!}Escort the bishop to the town of {s8}."
  ),
 
("iniau_the_banished","Iniau the Banished", qf_random_quest,
    "None",
    ),
 #chief acaba
 ("talk_to_zamoshie_elder", "Talk to the Llan Forfael Elder", 0, "A man mentioned that the elder of Llan Forfael needs help. Perhaps you might pay him a visit."),
 ("zamoshie_lower_taxes", "Peasant Taxes", 0, "Convince the warlord in Caer Ligualid to lower the taxes of the Llan Forfael."),
 ("deal_with_zamoshie_bandits", "North Bandits", 0, "Kill the North bandits before someone else does."),
 ("oim_bring_goods_zamoshie", "Bring 3 sets of Tools to Llan Forfael", 0, "Deliver 3 sets of Tools to Llan Forfael."),
 ("oim_trakay_icon", "Elusive Priest", 0, "Elusive Priest"),

 ("oim_getman_tampliers_archives", "The Archive", 0, "The Archive"),   
 ("oim_dmitriy_gerasim", "Veracius Evangelic", 0, "{!}Do not translate"),     
 ("freelancer_enlisted", "Freelancer Enlisted", 0, "{!}Do not translate"),     
 ("freelancer_vacation", "Freelancer Vacation", 0, "{!}Do not translate"),     

 ("blank_quest_2", "{!}blank_quest", qf_random_quest,#reserved for bandit lair quest for some reason gdw
  "{!}placeholder"
  ),

 ("iniau_horn","Find the Iniau Horn", qf_random_quest,#gdw temp holder no active mission now
    "None",
    ),
 
 ("beowulf_p2", "Find Dryhten Eadfrith near Dwfr", qf_random_quest,
  "None",
  ),

 ("get_horn_of_arthur", "Go to the Great Hall of Bebbanburh to get the Horn of Arthur from Bard Magnus before it is too late.", 0,
  "{!}Get King Arthur's great battle horn from Magnus Dictum in the Great Hall of Bebbanburh",
  ),
