...
never_broken = 65500 #fire arrow chief
...
#  ("Baggage",sokf_place_at_origin|sokf_entity_body,"package","bobaggage"),
  ...
  ("fake_houses_steppe_a",0,"fake_houses_steppe_a","0", [
    ...
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ...
  ("snowy_fence",sokf_destructible,"snowy_fence","bo_snowy_fence",
  [
    (ti_on_scene_prop_hit,[
        (store_trigger_param_1, ":instance"),
        (store_trigger_param_2, ":damage"),
        (call_script,"script_object_hit",":instance",":damage"),
        (call_script,"script_hit_prop",pos1),
    ]),
   (ti_on_scene_prop_destroy,[
        (store_trigger_param_1, ":instance"),
        (call_script,"script_object_destroy",":instance"),
        (call_script,"script_hit_prop",pos1),
    ]),
  ]),
  ...
  ("dungeon_door_entry_c",0,"dungeon_door_entry_c","bo_dungeon_door_entry_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("dungeon_door_direction_a",sokf_destructible|spr_hit_points(8000),"dungeon_door_direction_a","bo_dungeon_door_direction_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", 80000),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_dungeon_door_direction_a"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@Gate was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
  ("dungeon_door_direction_b",sokf_destructible|spr_hit_points(8000),"dungeon_door_direction_b","bo_dungeon_door_direction_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", 80000),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_dungeon_door_direction_b"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@Gate was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
  ...
  ("castle_h_battlement_a",0,"castle_h_battlement_a","bo_castle_h_battlement_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 1),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
...
##  ("banner_g22", 0, "banner_a01", "0", []),
##  ("banner_g23", 0, "banner_a02", "0", []),
##  ("banner_g24", 0, "banner_a03", "0", []),
##  ("banner_g25", 0, "banner_a04", "0", []),
##  ("banner_g26", 0, "banner_a05", "0", []),
##  ("banner_g27", 0, "banner_a06", "0", []),
##  ("banner_g28", 0, "banner_a07", "0", []),
##  ("banner_g29", 0, "banner_a08", "0", []),
##  ("banner_g30", 0, "banner_a09", "0", []),
...
#chief acaba
 # ("banner_kingdom_2d", 0, "banner_kingdom_2d", "0", []),
  ("banner_k21", 0, "banner_a15", "0", []), #chief modifica
  ...
  ("bucket_a",0,"bucket_a","bo_bucket_a",  []),
   ("straw_a",0,"straw_a","bo_straw_d",  []),
    ("straw_b",0,"straw_b","bo_straw_b",  []),
     ("straw_c",0,"straw_c","bo_straw_c",  []),
      ("cloth_a",0,"cloth_a","0", []),
  ("cloth_b",0,"cloth_b","0", []),
  ("mat_a",0,"mat_a","0", []),
  ("mat_b",0,"mat_b","0", []),
  ...
  ("house_extension_c",0,"house_extension_c","bo_house_extension_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),#reuse 
 ...
 ("windmill",0,"windmill","bo_windmill", [
  ...
  ("earth_gate_house_a",0,"earth_gate_house_a","bo_earth_gate_house_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("earth_gate_a",0,"earth_gate_a","bo_earth_gate_a", []), #adorno chief quiere q esto no se rompa
##  ("earth_gate_a",sokf_destructible|spr_hit_points(8000),"earth_gate_a","bo_earth_gate_a", [
##    (ti_on_init_scene_prop,[(assign, ":durability", 8000),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_earth_gate_a"),]),
##    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
##    (ti_on_scene_prop_destroy,[(display_message, "@Castle gate was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
  ...
  ("castle_courtyard_house_a",0,"castle_courtyard_house_a","bo_castle_courtyard_house_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 2),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
...
##    ]),     
  ...
  ("castle_drawbridge_open",sokf_destructible|spr_hit_points(8000),"castle_drawbridges_open","bo_castle_drawbridges_open", [
    (ti_on_init_scene_prop,[(assign, ":durability", 7500),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", 0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@drawbridge was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
  ("castle_drawbridge_closed",sokf_destructible|spr_hit_points(8000),"castle_drawbridges_closed","bo_castle_drawbridges_closed", [
    (ti_on_init_scene_prop,[(assign, ":durability", 7500),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", 0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@drawbridge was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
  ("spike_group_a",0,"spike_group_a","bo_spike_group_a", []),
  ("spike_a",0,"spike_a","bo_spike_a", []),
  ("belfry_a",sokf_moveable|sokf_destructible|spr_hit_points(15000),"belfry_a","bo_belfry_a",[#sokf_moveable
    (ti_on_init_scene_prop,[(assign, ":durability", 14800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_belfry_a"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(assign, reg60, ":damage"),(display_message, "str_delivered_damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[
    (store_trigger_param_1, ":instance_no"),
  ...
  ("belfry_b",sokf_moveable|sokf_destructible|spr_hit_points(15000),"belfry_b","bo_belfry_b", [
    (ti_on_init_scene_prop,[(assign, ":durability", 14800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_belfry_b"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(assign, reg60, ":damage"),(display_message, "str_delivered_damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[
    (store_trigger_param_1, ":instance_no"),
      (display_message, "@Belfry was destroyed."),
  ...
  ("belfry_b_platform_a",sokf_moveable|sokf_destructible|spr_hit_points(15000),"belfry_b_platform_a","bo_belfry_b_platform_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", 14800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_belfry_platform_a"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@Ladder was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),

  ("belfry_old",0,"belfry_a","bo_belfry_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("belfry_platform_a",sokf_moveable|sokf_destructible|spr_hit_points(15000),"belfry_platform_a","bo_belfry_platform_a",[#sokf_moveable
    (ti_on_init_scene_prop,[(assign, ":durability", 14800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_belfry_platform_a"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@Ladder was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
   ("belfry_platform_b",sokf_moveable|sokf_destructible|spr_hit_points(15000),"belfry_platform_b","bo_belfry_platform_b", [#sokf_moveable
    (ti_on_init_scene_prop,[(assign, ":durability", 14800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_belfry_platform_b"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@Ladder was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
...
###ram chief siege warfare
  ("ram_body", sokf_moveable|sokf_destructible|spr_hit_points(15000), "ram_body", "bo_ram_body", [
    (ti_on_init_scene_prop,[(assign, ":durability", 14800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_ram_body"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(assign, reg60, ":damage"),(display_message, "str_delivered_damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[
    (store_trigger_param_1, ":instance_no"),
  ...
  ("ram_shaft", sokf_moveable, "ram_shaft", "bo_ram_shaft", []),
...
#    ("ram_wheel", sokf_moveable, "ram_wheel", "bo_ram_wheel", []),
  ...
  ("village_hut_a",0,"village_hut_a","bo_village_hut_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("crude_fence",sokf_destructible,"fence","bo_fence",
  [
    (ti_on_scene_prop_hit,[
        (store_trigger_param_1, ":instance"),
        (store_trigger_param_2, ":damage"),
  ...
  ("crude_fence_small",sokf_destructible,"crude_fence_small","bo_crude_fence_small",
  [
    (ti_on_scene_prop_hit,[
        (store_trigger_param_1, ":instance"),
        (store_trigger_param_2, ":damage"),
  ...
  ("crude_fence_small_b",sokf_destructible,"crude_fence_small_b","bo_crude_fence_small_b",
  [
    (ti_on_scene_prop_hit,[
        (store_trigger_param_1, ":instance"),
        (store_trigger_param_2, ":damage"),
...
##pared fragil chief
    ("oim_tyn_spike",sokf_destructible,"oim_tyn_spike","bo_oim_tyn_spike",
  [
    (ti_on_scene_prop_hit,[
        (store_trigger_param_1, ":instance"),
        (store_trigger_param_2, ":damage"),
   ...
   (ti_on_scene_prop_destroy,[
    ...
    ("oim_tyn_b",sokf_destructible,"oim_tyn_b","bo_oim_tyn_b",
  [
    (ti_on_scene_prop_hit,[
        (store_trigger_param_1, ":instance"),
        (store_trigger_param_2, ":damage"),
   ...
   (ti_on_scene_prop_destroy,[
    ...
    ("oim_tyn",sokf_destructible,"oim_tyn","bo_oim_tyn",
  [
    (ti_on_scene_prop_hit,[
        (store_trigger_param_1, ":instance"),
        (store_trigger_param_2, ":damage"),
...
###chief pared fragil acaba

  ("ramp_12m",sokf_destructible|spr_hit_points(5000),"ramp_12m","bo_ramp_12m", [
    (ti_on_init_scene_prop,[(assign, ":durability", 4800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_ramp_12m"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@Ladder was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
  ("ramp_14m",sokf_destructible|spr_hit_points(5000),"ramp_14m","bo_ramp_14m", [
    (ti_on_init_scene_prop,[(assign, ":durability", 4800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_ramp_14m"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@Ladder was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
####ladders asalto mirathei chief para manteletes
##    ("ramp_invisible",sokf_invisible,"ramp_14m",0, [(ti_on_scene_prop_init,
##    [(store_trigger_param_1,reg59)]),
##    ]),
##  ("ramp_14m",0,"ramp_14m","bo_ramp_14m", [(ti_on_scene_prop_init,
...
####chief acaba
  ...
  ("portcullis",sokf_destructible|spr_hit_points(5000),"portcullis_a","bo_portcullis_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", 4800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_portcullis"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@Portcullis was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
  ...
  ("towngate_door_left",sokf_moveable,"door_g_left","bo_door_left", [
    (ti_on_init_scene_prop,[(assign, ":durability", 5000),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ...
  ("draw_bridge_a",sokf_destructible|spr_hit_points(8000),"draw_bridge_a","bo_draw_bridge_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", 8000),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_draw_bridge_a"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
    (ti_on_scene_prop_destroy,[(display_message, "@Draw bridge was destroyed."),(store_trigger_param_1, ":instance_no"),(call_script, "script_object_destroy", ":instance_no"),])]),
 ...
 ("siege_wall_a",0,"siege_wall_a","bo_siege_wall_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
###chief cambiado mantlets mantelete siege warfare
 ("siege_large_shield_a",sokf_moveable|sokf_destructible|spr_hit_points(300),"siege_large_shield_a","bo_siege_large_shield_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", 1800),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_siege_large_shield_a"),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(store_trigger_param_2, ":damage"),(assign, reg60, ":damage"),(display_message, "str_delivered_damage"),(call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),]),
     (ti_on_scene_prop_destroy,
      [
        (store_trigger_param_1, ":instance_no"),
        (val_add, "$g_last_destroyed_gourds", 1),
...
#anadido techo chief
#chief pared
 ("house_bebanburh",0,"house_bebanburh","bo_rhodok_house_passage_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
 ("roof2_bebanburh",0,"roof2_bebanburh","bo_rhodok_house_passage_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 1),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("city_bebanburh" ,0,"city_bebanburh" ,"bo_city_swad_05" , [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("castle_hlew" ,0,"castle_hlew" ,"bo_castle_hlew" , [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 1),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("castle_hlew2" ,0,"castle_hlew2" ,"bo_castle_hlew2" , [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 1),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),

#TEMPERED  chief #################  ADDED SCENE PROPS BEGIN  ####################
...
#################################################
#########SEA BATTLES chief BEGIN
#################################################
   ("ship_a",sokf_moveable,"longship","bo_longship", [   (ti_on_scene_prop_init,
   [
    (set_position_delta,0,0,0),
    (store_trigger_param_1, ":instance_no"),
...
#################################################
#########SEA BATTLES chief END
#################################################  
###chief scene props adorno
    ("ch_cross_1",0,"ch_cross_1","bo_ch_cross_1", []),
  ("vikinglonghouse1",0,"vikinglonghouse1","bo_vikinghouse1", []),
  ("celtic_cross_1",0,"celtic_cross_1","bo_celtic_cross_1", []),
...
##  ("ram_body", sokf_moveable, "ram_body", "bo_ram_body", []),
##  ("ram_shaft", sokf_moveable, "ram_shaft", "bo_ram_shaft", []),
###  ("ram_wheel", sokf_moveable, "ram_wheel", 0, []),
##    ("ram_wheel", sokf_moveable, "ram_wheel", "bo_ram_wheel", []),
####siege warfare chief ram acaba
  ...
  ("palisade_door_a",0,"palisade_door_a","bo_palisade_door_a", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("palisade_door_b",0,"palisade_door_b","bo_palisade_door_c", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ...
  ("box1",0,"box1","bo_box1", []),
  ("box2",0,"box2","bo_box2", []),
  ("water_mill",0,"water_mill","bo_water_mill", []),
  ("aqueduct",0,"aqueduct","bo_aqueduct", []),
##  ("crannog_a",0,"crannog_a","bo_crannog_a", [
##   (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
##    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
##  ("crannog_b",0,"crannog_b","bo_crannog_b", [
##   (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
##    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
##  ("crannog_c",0,"crannog_c","bo_crannog_c", [
##   (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
##    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("Kolba_c",0,"Kolba_c","bo_Kolba_c", [
   (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("Kolba_b",0,"Kolba_b","bo_Kolba_b", [
   (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("Kolba_a",0,"Kolba_a","bo_Kolba_a", [
   (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("cross_b",0,"cross_b","bo_cross", []),
  ("scene_prop_a",0,"scene_prop_a","bo_scene_prop_a", [
   (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
#otros scene props chief
    ("fyrkathouse",0,"Fyrkathouse","bo_fyrkathouse_coll", [
   (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
...
##    ("borghovdinghus",0,"borghovdinghus","bo_borghovdinghus", [
##   (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
##    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),

    ("olive_tree",0,"olive_tree","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_a",0,"s_tree_a","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_b",0,"s_tree_b","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_c",0,"s_tree_c","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_d",0,"s_tree_d","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_e",0,"s_tree_e","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_f",0,"s_tree_f","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_g",0,"s_tree_g","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_h",0,"s_tree_h","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_i",0,"s_tree_i","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
    ("s_tree_j",0,"s_tree_j","bo_tree_g_fm", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 5),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ...
  ("palisade_2",0,"palisade_2","bo_palisade_2", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("palisaden_1",0,"palisaden_1","bo_palisade_1", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
  ("palisaden_2",0,"palisaden_2","bo_palisade_2", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),

### Ships for sailing ### chief Phaiak
 ("klabautermann_ship1",sokf_moveable|spr_hit_points(8000000),"ship","bo_ship", [
   (ti_on_scene_prop_init,
   [
    (store_trigger_param_1, ":instance_no"),
    (assign, reg0, ":instance_no"),
    (assign, ":durability", 96000),
    (call_script, "script_initialize_ship", ":instance_no", ":durability", "spr_klabautermann_ship1"),
    (set_position_delta,0,0,0),
    #(particle_system_add_new, "psys_wake"),
   ]),
    (ti_on_scene_prop_hit,
    [
      (assign, ":flammability", 2),
      (store_trigger_param_1, ":instance_no"),
      (store_trigger_param_2, ":damage"),
      (try_begin),
        (troop_slot_ge, "trp_ship_colisions", ":instance_no", 0),
        (val_div, ":damage", 2),
      (try_end),
      (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"),
    ]),
    (ti_on_scene_prop_destroy,[
      (store_trigger_param_1, ":instance_no"),
      (assign, reg0, ":instance_no"),
      (display_message, "@Ship({reg0}) was destroyed."),
      (troop_set_slot, "trp_object_durability", ":instance_no", 0),
    ]),
  ]),

 ("klabautermann_ship1_sail_off",sokf_moveable,"ship_sail_off","bo_ship1_capsule", []),
...
# ("ship_own_sail_off",sokf_moveable,"ship_sail_off","bo_ship_sail_off", [ ]), 
 ("ship_enemy",sokf_moveable|sokf_destructible|spr_hit_points(100000),"ship","bo_ship", [ ]), 
#phaiak acaba
...
#("stonehenge",0,"stonehenge","bo_stonehenge", []),

#ROCK AND MOUNTAIN PACK V2#
  #COOP chief ############################################################################
...
######################################################################################## chief acaba
##("head_a_dynamic",sokf_moveable|sokf_dynamic_physics,"box_a","bo_box_a", [
##(ti_on_init_scene_prop,
##[
##   (store_trigger_param_1, ":prop_instance_no"),
##   (set_fixed_point_multiplier, 100),
...
##]),
 #Adorno scene props
  ...
  ("house_saxon_wattle_daub",0,"house_saxon_wattle_daub","bo_house_saxon_wattle_daub", [
    (ti_on_init_scene_prop,[(assign, ":durability", never_broken),(store_trigger_param_1, ":instance_no"),(call_script, "script_flammable_object_initialize", ":instance_no", ":durability",0),]),
    (ti_on_scene_prop_hit,[(assign, ":flammability", 10),(store_trigger_param_1, ":instance_no"),(call_script, "script_cf_flammable_object_hit", ":instance_no", pos1,":flammability")])]),
#adorno scene props acaba  
#Moeckerkalfie scene props
