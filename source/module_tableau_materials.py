...
##Narf's transitional armor begin #gdw from floris 
...
##Narf's transitional armor end#gdw"mesh_ar_pla_t6_heraldic_tableau_banner
...
##     (else_try),
##       (eq, ":type", 1),
##       (cur_tableau_add_override_item, "itm_blackhood"),
##       (cur_tableau_add_override_item, "itm_ptunic3"),
##       (cur_tableau_add_override_item, "itm_cheap_shoes"),
##       (assign, ":animation", "anim_pose_1"),
##     (else_try),
##       (eq, ":type", 2),
##       (cur_tableau_add_override_item, "itm_merch_tunicwt"),
##       (cur_tableau_add_override_item, "itm_cheap_shoes"),
...
##     (else_try),
##       (eq, ":type", 5),
##       (cur_tableau_add_override_item, "itm_ptunic5"),
##       (cur_tableau_add_override_item, "itm_leather_boots1"),
##       (assign, ":animation", "anim_pose_3"),
##     (else_try),
##       (eq, ":type", 6),
##       (cur_tableau_add_override_item, "itm_bluepantsbody_woad04"),
##       (cur_tableau_add_override_item, "itm_leather_boots1"),
...
##     (else_try),
##       (eq, ":type", 9),
##       (cur_tableau_add_override_item, "itm_scale_bronze_blueorange"),
##       (cur_tableau_add_override_item, "itm_greaves1"),
