...
def troop_properties(lvl, type, culture, other_items, flags=None, skills=None, shields=None, faction=None):
    ...
    return [flags,
            ...
            other_items + possible_shields + horses, attrs['attrs'], attrs['wp'],
            skills]


items_pict_recruit = ['itm_stones1','itm_slingrocks','itm_basic_sling','itm_leather_shoes','itm_shoes2bare','itm_shoes2bare','itm_looseblackhood','itm_head_wrappings','itm_ptunic7','itm_farmertunic26','itm_ptunic3','itm_ptunic1','itm_ptunic2','itm_ptunic12','itm_german_tunic2','itm_ptunic3','itm_ptunic2','itm_knifechp','itm_clubcudgel','itm_stones1','itm_clubsmooth','itm_quarter_staff','itm_sickle','itm_club_stick']
items_pict_woman = ['itm_cavaljavelins','itm_cavaljavelins','itm_slingrocks','itm_basic_sling','itm_leather_shoes','itm_pictpaintfemale1','itm_pictpaintfemale2','itm_pictpaintfemale3','itm_pictpaintfemale4','itm_pictpaintfemale2','itm_pictpaintfemale2','itm_pictpaintfemale3','itm_pictpaintfemale4','itm_pictpaintfemale3','itm_pictpaintfemale4','itm_pictish_waraxet2','itm_medium_speaript3']
items_pict_archer = ['itm_arrows1','itm_bolts','itm_shortbow','itm_huntingbow','itm_pict_crossbow','itm_leather_shoes','itm_shoes2bare','itm_hoodnewblu','itm_hoodnewblk','itm_hoodnewwht','itm_ptunic10','itm_tunicsleevelessgreen7','itm_tunicsleevelessgreenred','itm_tunicsleeveless2','itm_tunicsleeveless2','itm_tunicsleeveless2','itm_tunicsleevelessc','itm_tunicsleevelessc','itm_redpantsbody_woad11','itm_bluepantsbody_woadhvy12t2','itm_pictish_waraxet2','itm_clubcudgel','itm_scianshswordt1','itm_scianshswordbone']
items_pict_footman = ['itm_javelins','itm_darts','itm_leather_shoes','itm_shoes2bare','itm_looseblackhood','itm_head_wrappings','itm_common_hood','itm_ptunic3','itm_tunicsleevelessc','itm_ptunic5','itm_tunicsleeveless2','itm_cloaked_leathertunict2','itm_ptunic7','itm_pictish_waraxet2','itm_medium_speaript3']
items_pict_skirmisher3 = ['itm_cavaljavelins','itm_cavaljavelins','itm_slingrocks','itm_basic_sling','itm_fustibalus','itm_shoes2bare','itm_noble_shoesorange','itm_war_paintbody_two','itm_bluepantsbody_woad05','itm_bluepantsbody_woad04','itm_bluepantsbody_woad02t2','itm_celtcloakedbody01','itm_celtcloakedbody02','itm_celtcloakedbody03','itm_picto_paintfat1','itm_war_paintbody4','itm_pelt_coat1','itm_pictish_waraxet2','itm_medium_speaript3','itm_scianshswordbone','itm_scianshswordt1']
items_pict_horsesquire3 = ['itm_javelins','itm_shoes2bare','itm_pelt_coat2','itm_bluepantsbody_woad04','itm_greypantsbody_woad01','itm_blackpantsbody_woad10','itm_redpantsbody_woad11','itm_war_paintbody13','itm_war_paintbody4','itm_war_paintbody6','itm_spear_lightgael','itm_warspear_godelict3','itm_twohand_speart3','itm_scianshswordbone','itm_scianshswordt1','itm_sciansword']
items_pict_skirmisher4 = ['itm_javelins','itm_javelins','itm_shoes2bare','itm_noble_shoesorange','itm_byrnietunicb','itm_scale_vest_red','itm_linen_coatbrown','itm_skullcap_reinforcedt2','itm_skullcapt1','itm_rathos_bowlhelmet','itm_bowlhelmet','itm_spear_briton2ht3','itm_hunting_spear','itm_warspear_godelict3','itm_twohand_speart3','itm_irish_shsword','itm_scianshswordt1']
items_pict_infantry4 = ['itm_javelins','itm_leather_gloves1','itm_shoes2bare','itm_noble_shoesorange','itm_richlong_tunic3','itm_linen_coatwhite','itm_linen_coatblue','itm_mailbyrniered','itm_skullcap_reinforcedt1','itm_skullcap_reinforcedt2','itm_bowl_helmet_nasal','itm_bowlhelmet','itm_irish_shsword','itm_noble_shswordt2','itm_rich_shswordt3','itm_scianshswordbone']
items_pict_infantry5 = ['itm_throwing_spear','itm_leather_gloves1','itm_leather_bootstall','itm_splinted_leather_greaves','itm_mailtunic_brownclk','itm_mailtunic_wht','itm_mail_goatist','itm_lorica_brightgreen','itm_lorica_dirtygrn','itm_lorica_whitbrn','itm_scale_vest_red','itm_mailtunic_redbrown','itm_mailtunic_blk','itm_briton_helm','itm_mierce_helmt3','itm_briton_helm_3','itm_szpadelhelm3t2','itm_szpadelhelm4engravedt3','itm_szpadelhelm5engravedt3','itm_pictish_longsword1','itm_gaelicsword1','itm_celtic_sword','itm_scianshswordt1']
items_pict_horseman = ['itm_cavaljavelins','itm_cavaljavelins','itm_leather_shoes','itm_noble_shoesorange','itm_bluepantsbody_woad02t2','itm_picto_paintfat2','itm_hide_coat1','itm_hide_coat6','itm_vae_thickcoat3','itm_vae_thickcoat2','itm_vae_thickcoat1','itm_pelt_coat1','itm_pelt_coat2','itm_longspeart3','itm_spear_briton_longt2','itm_scianswordbone','itm_axe2','itm_irish_longsword']
items_pict_noblecavalry = ['itm_cavaljavelins','itm_cavaljavelins','itm_leather_shoes','itm_shoes2bare','itm_scale_bronze_blueorange','itm_scale_vest_red','itm_lorica_brightgreen','itm_rathos_bowlhelmet','itm_briton_helmslvtrimt3','itm_szpadelhelm2engraved','itm_mierce_helmt3','itm_longspeart3','itm_scianshswordt1','itm_gaelicsword1','itm_irish_longsword']
items_pict_messenger = ['itm_javelins','itm_leather_shoes','itm_shoes2bare','itm_shoes2bare','itm_celtcloakedbody01','itm_celtcloakedbody02','itm_celtcloakedbody03','itm_bluepantsbody_woad04','itm_bluepantsbody_woad04','itm_bluepantsbody_woad05','itm_bluepantsbody_woad04','itm_spear_briton_longt2','itm_scianshswordbone','itm_scianshswordt1','itm_sciansword']
items_pict_deserter = ['itm_cavaljavelins','itm_cavaljavelins','itm_cavaljavelins','itm_shoes2bare','itm_shoes2bare','itm_tunicsleevelessgreen7','itm_tunicsleeveless2','itm_war_paintbody_two','itm_picto_paintfat2','itm_bluepantsbody_woad02t2','itm_bluepantsbody_woad02t2','itm_greypantsbody_woad01','itm_blackpantsbody_woad10','itm_leather_captainhelm','itm_rathos_bowlhelmet','itm_bowl_helmet_nasal','itm_hunting_spear','itm_warspear_godelict3','itm_twohand_speart3','itm_scianshswordbone','itm_scianshswordt1']
items_pict_guard = ['itm_javelins','itm_leather_gloves1','itm_leather_shoes','itm_cloaked_tunic2','itm_ladytunicgodelic','itm_cloaked_tunic2','itm_linen_coatblue','itm_bowlhelmet','itm_irish_shsword','itm_scianshswordt1']
...
pict_troops = [
    ...
    ["picto_portaestandarte","Samhladh","Samhladh",tf_guarantee_armor,0,0,'fac_neutral',['itm_leather_shoes','itm_shoes2bare','itm_shoes2bare','itm_noble_shoesorange','itm_war_paintbodyus','itm_war_paintbody1','itm_war_paintbody2','itm_war_paintbody3','itm_war_paintbody5','itm_war_paintbody6','itm_bluepantsbody_woad04','itm_war_paintbody_two','itm_wessexbanner6','itm_heraldicbannert3','itm_war_paintbody_two','itm_war_paintbodyus','itm_trophy_b'],def_attrib2|level(23),wp(165),knows_warrior_normal,khergit_face_young_1,khergit_face_older_4],
    ["picto_cuerno","Hornman","Hornmen",tf_guarantee_boots|tf_guarantee_armor,0,0,'fac_neutral',['itm_leather_shoes','itm_shoes2bare','itm_shoes2bare','itm_noble_shoesorange','itm_war_paintbody8','itm_war_paintbody11','itm_war_paintbody7','itm_war_paintbody8','itm_war_paintbody10','itm_war_paintbody11','itm_war_paintbody12','itm_horn1','itm_trophy_a'] + items_shields['common'][0]['light'],def_attrib2|level(15),wp(110),knows_warrior_normal,khergit_face_young_1,khergit_face_older_4],
    ["picto_sacerdote","Cleric","Clergy",tf_guarantee_boots|tf_guarantee_armor,0,0,'fac_neutral',['itm_leather_shoes','itm_shoes2bare','itm_shoes2bare','itm_noble_shoesorange','itm_monk_robe','itm_robe_beige','itm_stones1','itm_staff1'],def_attrib|level(23),wp(165),knows_cleric,khergit_face_young_1,khergit_face_older_4],
...
items_irish_recruit = ['itm_stones1','itm_slingrocks','itm_basic_sling','itm_leather_shoes','itm_shoes2bare','itm_shoes2bare','itm_hoodnewwht','itm_blackhood','itm_ptunicwhite','itm_german_tunic2','itm_ptunic7','itm_ptunic3','itm_ptunic7','itm_shirtblue','itm_ptunic1','itm_thick_body','itm_knifechp','itm_staff_pitchfork','itm_clubcudgel','itm_spear_sharppitchfork','itm_quarter_staff','itm_sickle']
items_irish_archer = ['itm_arrows1','itm_shortbow','itm_huntingbow','itm_shoes2bare','itm_shoes2bare','itm_hoodnewwht','itm_blackhood','itm_head_wrappings','itm_common_hood','itm_celtcloakedbody06','itm_bluepantsbody_woad04','itm_bluepantsbody_woad04','itm_german_tunic2','itm_ptunic7','itm_cloaked_leathertunict2','itm_german_tunic2','itm_ptunic1','itm_tunicsleeveless3','itm_tunicblue8','itm_clubsmooth','itm_scianshswordt1','itm_scianshswordbone']
items_irish_footman = ['itm_slingrocks','itm_basic_sling','itm_leather_shoes','itm_shoes2bare','itm_shoes2bare','itm_blackhood','itm_common_hood','itm_celta_cloak1','itm_celta_cloak1','itm_red_cloak','itm_ptunic9','itm_ptunic3','itm_briton_tunic2','itm_ptunic7','itm_redpantsbody_woad11','itm_bluepantsbody_woad05','itm_tunicsleeveless6','itm_tunicsleeveless8','itm_tunicsleevelessc','itm_scianshswordbone','itm_scianshswordt1','itm_clubcudgel']
items_irish_infantry3 = ['itm_javelins','itm_shoes2bare','itm_noble_shoesorange','itm_gaelic_jacketgray','itm_gaelic_jacketgray','itm_ptunic7','itm_bltunic08','itm_bltunic11','itm_bltunic05','itm_scianshswordbone','itm_axe_1hlongt2','itm_pictish_boar_speart2','itm_hunting_spear']
items_irish_skirmisher3 = ['itm_darts','itm_wooden_javelins','itm_cavaljavelins','itm_shoes2bare','itm_noble_shoesorange','itm_gaelic_jacketgray','itm_gaelic_jacketgrn','itm_cloaked_tunicorange','itm_cloaked_tunicgreen','itm_vae_thickcoat1','itm_gatheredcloaks4','itm_byrnietunice','itm_leathercap1','itm_skullcap_reinforcedt1','itm_head_wrappings','itm_scianshswordt1','itm_axe_1hlongt2','itm_spear_lightgael']
items_irish_skirmisher4 = ['itm_cavaljavelins','itm_cavaljavelins','itm_shoes2bare','itm_shoes2bare','itm_byrnietunice','itm_vaelicus_tunic27','itm_scale_bronze_blueorange','itm_scale_bronze_fadedgrn','itm_mail_sleevelessgrn','itm_mail_sleevelessbrn','itm_mail_sleevelessgrnorange','itm_skullcap_reinforcedt1','itm_skullcapt1','itm_bronzebowlhelmet','itm_ironceltbowlhelmet','itm_scianshswordbone','itm_pommel_swordt2','itm_pommel_swordt3','itm_godelic_swordt2','itm_godelic_swordt3']
items_irish_infantry4 = ['itm_javelins','itm_shoes2bare','itm_shoes2bare','itm_skullcap_reinforcedt1','itm_leathercap1','itm_bowlhelmet','itm_scale_brown_armor','itm_noblearmor5res','itm_scianshswordbone','itm_warspear_godelict3','itm_godelic_swordt3']
items_irish_infantry5 = ['itm_throwing_spear','itm_leather_gloves1','itm_leather_shoes','itm_shoes2bare','itm_scale_brown_armor','itm_noblearmor5res','itm_mailnoble_dkgrnclk','itm_mailnoble_brwngryclk','itm_szpadelhelm1','itm_szpadelhelm2engraved','itm_szpadelhelm3t2','itm_szpadelhelm4engravedt3','itm_szpadelhelm5engravedt3','itm_red_cloak_hood','itm_scianshswordt1','itm_pommel_swordt2','itm_pommel_swordt3','itm_gaelicsword1','itm_warspear_godelict3','itm_celtic_sword','itm_britonswordt2']
items_irish_horseman = ['itm_cavaljavelins','itm_cavaljavelins','itm_shoes2bare','itm_noble_shoesorange','itm_linen_coatbrown','itm_linen_coatblue','itm_linen_coattan','itm_linen_coatwcloak','itm_helm_leathert2','itm_leathercap1','itm_bronzebowlhelmet','itm_ironceltbowlhelmet','itm_scianswordbone','itm_pommel_swordt2','itm_spearlong','itm_spear_briton_longt2']
items_irish_noblecavalry = ['itm_javelins','itm_javelins','itm_greaves1','itm_noble_shoesblue','itm_noble_shoesorange','itm_scale_brown_armor','itm_lorica_whitbrn','itm_scale_bronzegreen','itm_mail_sleevelessgrn','itm_mailnoble_brwnwhtclk','itm_mailnoble_ltbrwnclk','itm_spangenhelmgerm_trim','itm_romanelitehelmt3','itm_szpadelhelm1','itm_szpadelhelm3t2','itm_espada_kirkburn','itm_pict_princep_swordt3res','itm_gaelicsword1','itm_spearlong']
items_irish_messenger = ['itm_leather_gloves1','itm_javelins','itm_leather_shoes','itm_shoes2bare','itm_nobleman_outfit','itm_gaelic_jacketgrn','itm_saxon_tunic7','itm_saxon_tunic7','itm_saxon_tunic7','itm_vaelicus_tunic35','itm_vaelicus_tunic36','itm_scianshswordt1','itm_scianshswordbone','itm_axe_1hlongt2','itm_spear_lightgael','itm_warspear_godelict3']
items_irish_deserter = ['itm_javelins','itm_javelins','itm_javelins','itm_javelins','itm_javelins','itm_leather_shoes','itm_shoes2bare','itm_shoes2bare','itm_cloaked_leathertunict2','itm_german_tunic2','itm_ptunic1','itm_tunicsleeveless3','itm_tunicblue8','itm_german_tunic5','itm_saxon_tunic7','itm_skullcap_reinforcedt1','itm_skullcap_reinforcedt2','itm_bronzebowlhelmet','itm_scianshswordbone','itm_axe_1hlongt2','itm_spear_lightgael','itm_warspear_godelict3']
items_irish_guard = ['itm_javelins','itm_leather_shoes','itm_noblearmor7res','itm_noblearmor8res','itm_wealthytunic5','itm_leathercap1','itm_rathos_bowlhelmet','itm_scianshswordbone','itm_warspear_godelict3']
...
irish_troops = [
    ...
    ["irish_bannerman","Meirgeach","Meirgeach",tf_guarantee_boots|tf_guarantee_armor,0,0,'fac_neutral',['itm_leather_shoes','itm_noble_shoesorange','itm_celta_cloak1','itm_celta_cloak1','itm_nobleman_outfit','itm_gaelic_jacketgrn','itm_saxon_tunic7','itm_saxon_tunic7','itm_saxon_tunic7','itm_vaelicus_tunic35','itm_vaelicus_tunic36','itm_wessexbanner7','itm_wessexbanner8','itm_heraldicbannert3','itm_trophy_b'],def_attrib2|level(23),wp(170),knows_warrior_normal,vaegir_face_young_1,vaegir_face_old_2],
    ["irish_priest","Cleric Goidel","Cleric Goidels",tf_guarantee_boots|tf_guarantee_armor,0,0,'fac_neutral',['itm_leather_shoes','itm_shoes2bare','itm_shoes2bare','itm_noble_shoesorange','itm_monk_robe','itm_blackwornrobe','itm_stones1','itm_knifechp'],def_attrib|level(23),wp(165),knows_cleric,sac_face_1,sac_face_2],
...
items_saxon_horseman1 = ['itm_javelins','itm_shoes1blue','itm_shoes2green','itm_greaves1','itm_noble_shoesorange','itm_jack_armorgreen','itm_jack_armorgreen','itm_lorica_pink','itm_noblearmor14res','itm_mailnoble_ltbrwnclk','itm_lorica_greyrd','itm_spangenhelmb1','itm_frisian_helm3t2','itm_saxon_helmt2','itm_spangenhelma_yellow','itm_hornhelmet2','itm_hornhelmet1','itm_hornhelmet3_t2','itm_maul1h_blunt','itm_spearlong','itm_saxonswordt2','itm_germanicswordt2']
items_saxon_messenger = ['itm_leather_gloves1','itm_javelins','itm_shoes2green','itm_shoes2grey','itm_greaves1','itm_noble_shoesorange','itm_greaves1','itm_ptunic3','itm_ptunicwhite','itm_ptunic12','itm_wessex_tunic3','itm_ptunic2','itm_mercia_tunicgrn','itm_blue_shorttunic','itm_ptunic13','itm_spear1','itm_spearlight','itm_langseaxt2']
...
items_engle_messenger = ['itm_leather_gloves1','itm_noble_shoesorange','itm_shoes1','itm_noble_shoesorange','itm_shoes2green','itm_noble_shoesorange','itm_wessex_tunic3','itm_ptunic2','itm_mercia_tunicgrn','itm_blue_shorttunic','itm_ptunic13','itm_spear1','itm_spearlight','itm_langseaxt2']
